...
TreasureArenaMR 是一个基于 Pico 4 的 VR/MR 多人联机双队夺宝竞技游戏。

玩家分为红队和蓝队，在同一 MR/VR 场景中争夺宝物。玩家可以拾取宝物并带回己方基地提交得分，也可以使用武器攻击敌方玩家。玩家 HP 归零后不会被虚拟传送，而是进入适合 MR 空间体验的“濒死撤离状态”，需要真实走回己方复活区，并在倒计时结束后重新参与游戏。
