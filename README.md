...
TreasureArenaMR 是一个基于 Pico 4 的 VR/MR 多人联机双队夺宝竞技项目。

玩家分为红队和蓝队，在由地图编辑器生成的 MR/VR 场景中寻找、争夺、携带并提交宝物获得分数。玩家可以使用武器攻击对手，被击败的玩家不会被虚拟传送，而是进入更适合 MR 的“濒死撤离状态”：玩家需要在真实空间中走回己方复活区，并在复活倒计时结束后重新加入对局。
